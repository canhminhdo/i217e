...
\begin{problem}
$\forall L \in \mathtt{NatList}, \rmx{diff}(\rmx{rev}(L), L) = nil$.
\end{problem}
\begin{proof}
...
\item[(1) Base case]~\\
\noindent
What to show: $\quad \rmx{diff}(\rmx{rev}(nil), nil) = nil$.
\begin{align*}
%%% LHS
\rmx{diff}(\under{\rmx{rev}(nil)}, nil)
	&\larrow \under{\rmx{diff}(nil, nil)} \tag{by rev1} \\
	&\larrow nil \tag{by diff1}
\end{align*}

\item[(2) Induction case]~\\
What to show: $\quad \rmx{diff}(\rmx{rev}(x \mid l), x \mid l) = nil$ \\
Induction hypothesis: $\quad \rmx{diff}(\rmx{rev}(l), l) = nil$  \\
...
\begin{align*}
%%% LHS
\rmx{diff}(\under{\rmx{rev}(x \mid l)}, x \mid l)
	&\larrow \under{\rmx{diff}(\rmx{rev}(l) \rel{@} (x \mid l), x \mid l)} \tag{by rev2} \\
	&\larrow \rmx{diff}(\rmx{rev}(l), x \mid l) \rel{@} \under{\rmx{diff}(x \mid l, x \mid l)} \tag{by Problem 9 - Lemma 1} \\
	&\larrow \under{\rmx{diff}(\rmx{rev}(l), x \mid l) \rel{@} nil} \tag{by Problem 15} \\
	&\larrow \under{\rmx{diff}(\rmx{rev}(l), x \mid l)} \tag{by Problem 4 - Lemma 2} \\
	&\larrow \rmx{drop}(\under{\rmx{diff}(\rmx{rev}(l), l)}, x) \tag{by Problem 14} \\
