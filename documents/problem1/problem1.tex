...
\begin{align*}
\rmx{fold*}(\under{\rmx{rev}(x \rel{|} l)}) &\larrow \under{\rmx{fold*}(\rmx{rev}(l)\rel{@}(x \rel{|} nil))} \tag{by rev2} \\
...
\begin{align*}
\rmx{fold*}(\under{nil \rel{@} l2}) &\larrow \rmx{fold*}(l2) \tag{by @1} \\
\under{\rmx{fold*}(nil)} \rel{*} \rmx{fold*}(l2) &\larrow \under{\rmx{s}(0) \rel{*} \rmx{fold*}(l2)} \tag{by fold*-1} \\
...
\begin{align*}
\rmx{fold*}(\under{(e \rel{|} l1) \rel{@} l2}) &\larrow \under{\rmx{fold*}(e \rel{|} (l1 \rel{@} l2))} \tag{by @2} \\
&\larrow e \rel{*} \under{\rmx{fold*}(l1 \rel{@} l2)} \tag{by fold*-2} \\
&\larrow e \rel{*} (\rmx{fold*}(l1) \rel{*} \rmx{fold*}(l2)) \tag{by IH} \\
\under{\rmx{fold*}(e \rel{|} l1)} \rel{*} \rmx{fold*}(l2) &\larrow \under{(e \rel{*} \rmx{fold*}(l1)) \rel{*} \rmx{fold*}(l2)} \tag{by fold*-2} \\
